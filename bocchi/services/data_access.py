...
from bocchi.services.cache import Cache, CacheRoot, cache_config
from bocchi.services.cache.config import COMPOSITE_KEY_SEPARATOR, CacheMode
from bocchi.services.db_context import Model, with_db_timeout
...
class DataAccess(Generic[T]):
    ...
    使用示例:
    ```python
    from bocchi.services import DataAccess
