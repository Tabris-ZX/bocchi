...
async def update_model_path(old_path: str, new_path: str, db_url: str | None = None) -> bool:
    """更新模型路径"""
    try:
...
async def get_current_model_path() -> str:
    ...
    try:
        ...
        return f"bocchi.plugins.{plugin_dir}.model"
...
async def run_migration():
    """执行迁移"""
    old_paths = [
        "bocchi.plugins.quote.model",
        "bocchi.plugins.nonebot_plugin_quote.model",
        "bocchi.plugins.bocchi_plugin_quote.model",
    ]
