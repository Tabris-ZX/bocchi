...
from bocchi.builtin_plugins.auto_update.config import REQ_TXT_FILE_STRING
...
from bocchi.services.plugin_init import PluginInitManager
from bocchi.utils.github_utils import GithubUtils
from bocchi.utils.github_utils.models import RepoAPI
from bocchi.utils.http_utils import AsyncHttpx
from bocchi.utils.image_utils import BuildImage, ImageTemplate, RowStyle
from bocchi.utils.manager.virtual_env_package_manager import VirtualEnvPackageManager
from bocchi.utils.utils import is_number
...
class StoreManager:
    ...
    async def remove_plugin(cls, plugin_id: str) -> str:
        ...
        if plugin_info.is_dir:
            ...
            path.unlink()
        await PluginInitManager.remove(f"bocchi.{plugin_info.module_path}")
