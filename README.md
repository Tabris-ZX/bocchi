...
[![tencent-qq](https://img.shields.io/badge/%E7%BE%A4-是波奇酱哒-red?style=logo=tencent-qq)](https://qm.qq.com/q/mRNtLSl6uc)
[![tencent-qq](https://img.shields.io/badge/%E7%BE%A4-波奇的技术群-c73e7e?style=logo=tencent-qq)](https://qm.qq.com/q/YYYt5rkMYc)
...
“波奇是<strong>[椛椛](https://github.com/FloatTech/ZeroBot-Plugin)</strong>的好朋友！”
...
|          [WebUi](https://github.com/zhenxun-org/zhenxun_bot)           |   管理   |       [hibikier](https://github.com/HibiKier)       | 基于波奇 WebApi 的 webui 实现 [预览](#-webui界面展示) |
...
> [!NOTE]
> 波奇原 `plugins` 插件文件夹已迁移至 [插件仓库](https://github.com/zhenxun-org/zhenxun_bot_plugins) ，现在本体仅保留核心功能
...
- 邀请入群提醒(别人邀请波奇入群，可配置自动同意)

- 添加好友提醒(别人添加波奇好友，可配置自动同意)
